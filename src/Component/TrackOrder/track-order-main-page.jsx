    ...
    <>
      ...
      <div className="order-tracking-container">
        ...
        <div className="d-flex justify-content-center">
          <div className="order-tracking-support-card w-xxl-25 my-5">
            ...
            <div className="d-flex justify-content-center mt-5">
              <a
                aria-label="Track your order on Shipmozo"
                target="_"
              ...
              >
                <button
                  ...
                  type="submit"
                  className="order-tracking-btn-cta"
                >
                  Track Order
                </button>
              </a>
        ...
        <div className="order-tracking-support-section">
          ...
          <p className="order-tracking-support-subtitle">
          ...
          <div className="order-tracking-support-cards">
            {supportOptions.map((option, index) => (
              <div key={index} className="order-tracking-support-card">
                ...
                <h3 className="order-tracking-support-card-title">
                  {option.title}
                </h3>
                <p className="order-tracking-support-card-description">
                  {option.description}
                </p>
              </div>
            ))}
