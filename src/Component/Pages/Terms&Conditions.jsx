...
import Image from "../../asset/img/Policy/Terms and conditions.png";

const TermsConditions = () => {
  return (
    <>
      <div className="privacy">
        <div className="privacy-heading policy-bg d-flex justify-content-center text-light text-center text-uppercase">
          <img src={Image} alt="" className="mb-2 w-100 h-100" />
        </div>
        <div className="container privacy-list py-5">
          <p className="fs-5 w-75 m-auto fw-bold">
          ...
          <ul className="fs-5 w-75 m-auto pt-4">
            <li>
              ...
              of domain name https://gauswarn.com ('Website'), including the
            ...
            <li>
            All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Indore and Madhya Pradesh.
            </li>
            <li>
